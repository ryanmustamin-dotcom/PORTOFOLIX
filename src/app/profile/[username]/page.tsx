import { getUserByUsername, getProjectsByUser } from '@/lib/data';
...
export default function ProfilePage({ params }: { params: { username: string } }) {
  ...
  const userProjects = getProjectsByUser(params.username);

  return (
    <div className="container py-8">
      <Card className="mb-8 overflow-hidden">
        <div className="h-48 bg-muted-foreground/20 relative">
          <Image src="https://picsum.photos/seed/headerbg/1200/300" alt="Profile banner" fill objectFit="cover" data-ai-hint="abstract background" />
        </div>
        <div className="p-6">
